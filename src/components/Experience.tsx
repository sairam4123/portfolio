    ...
    <section id="experience" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          <span className="text-blue-500/40 font-mono text-sm font-medium">03</span>
              ...
              <div key={i} className="pl-16 relative">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-blue-500/30 hover:bg-white/[0.07] transition-all duration-300">
                  <div className="flex flex-wrap items-start justify-between gap-3 mb-1">
                    ...
                    <span className="text-[#8892b0] text-xs font-mono bg-blue-600/10 border border-blue-500/20 px-3 py-1.5 rounded-full whitespace-nowrap">
                      {job.period}
                    </span>
                  </div>
