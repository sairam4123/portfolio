  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        <p className="text-[#8892b0] text-lg mb-3">Hello, I&apos;m</p>
        ...
        <h2 className="text-lg md:text-xl text-[#8892b0] font-light mb-6 max-w-xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          <a
            href="#projects"
            className="px-7 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-semibold transition-colors duration-200 shadow-[0_0_20px_rgba(59,130,246,0.3)]"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="px-7 py-3 border border-blue-500/50 hover:border-blue-400 text-blue-400 hover:text-blue-300 rounded-lg font-semibold transition-colors duration-200"
          >
            Contact Me
          </a>
        </div>
